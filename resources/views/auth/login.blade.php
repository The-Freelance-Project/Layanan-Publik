    ...
    <div class="flex flex-col">
        <a href="{{ route('redirect', ['driver' => 'google']) }}" class="mt-4 w-full flex justify-center">  
            <button
                ...
                <span class="text-sm font-semibold text-white tracking-wider">Login dengan Google</span>
            </button>
        </a>
        ...
        <a href="{{ route('redirect', ['driver' => 'facebook']) }}" class="mt-4 w-full flex justify-center">  
            <button
                ...
                <span class="text-sm font-semibold text-blue-600 tracking-wider group-hover:text-white">Login dengan Facebook</span>
            </button>
        </a>
